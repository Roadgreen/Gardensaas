...
const features = [
  {
    ...
    description: 'Get tips tailored to your soil, climate, and plants',
  },
  {
    icon: Bug,
    title: 'Pest & disease diagnosis',
    description: 'Describe symptoms, get organic solutions',
  },
  {
    icon: Calendar,
    title: 'Seasonal guidance',
    description: 'Know exactly when to plant, prune, and harvest',
  },
  {
    icon: FlaskConical,
    title: 'Soil & composting tips',
    description: 'Improve your soil for healthier plants',
  },
];
    ...
    >
      ...
      <div className="p-5">
        ...
        <h4 className="text-green-50 text-lg font-semibold text-center mb-2">
          Unlock your personal garden advisor
        </h4>
        <p className="text-green-300/60 text-sm text-center mb-5">
          Get expert gardening advice tailored to your garden, available 24/7.
        </p>
        ...
        <p className="text-green-500/40 text-xs text-center mt-3">
          10 AI questions per day included with PRO
        </p>
      </div>
    </motion.div>
  );
